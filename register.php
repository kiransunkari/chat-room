...
/* Second input field */
.register-form .content .password, .register-form .content .pass-icon {
	margin-top: 25px;
}

.register-form .content .input:hover {
	background: #dfe9ec;
	color: #414848;
}
...
.register-form .footer .button:hover {
	background: #3f9db8;
...
.register-form .footer .button:focus {
	position: relative;
	bottom: -1px;
...
.register-form .footer .register:hover {
	color: #3f9db8;
}

.register-form .footer .register:focus {
	position: relative;
	bottom: -1px;
}
</style>

<form class="register-form" name="reg" action="create_user.php" onsubmit="return validateForm()" method="post">

  <div class="header">
		<h1>Registration Form</h1>
		<span>Fill out the form below to register to my super awesome chat.</span>
		</div>
  <div class="content">
  
  
   <input name="name" type="text" class="input username" placeholder="Name" />
   <input name="contact" type="text" class="input username" placeholder="Contact Number" />
